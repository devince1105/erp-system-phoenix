...
namespace ERP.Host.Migrations.Inventory
{
    ...
    [Migration("20260727125325_AddInventoryBomAndWorkOrder")]
    partial class AddInventoryBomAndWorkOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERP.Modules.Inventory.Domain.Entities.Bom", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Boms", "Inventory");
                });

            modelBuilder.Entity("ERP.Modules.Inventory.Domain.Entities.BomItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ERP.Modules.Inventory.Domain.Entities.WorkOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ERP.Modules.Inventory.Domain.Entities.BomItem", b =>
                {
                    b.HasOne("ERP.Modules.Inventory.Domain.Entities.Bom", "Bom")
                        .WithMany("Items")
                        .HasForeignKey("BomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ERP.Modules.Inventory.Domain.Entities.Product", "ComponentProduct")
                        .WithMany()
